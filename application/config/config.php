...
|
*/
$config['base_url'] = 'http://furryavalon.net/';
...
$config['cookie_domain']	= '.furryavalon.net';
$config['cookie_path']		= '/';
...
$config['csrf_token_name'] = 'fanet_csrf';
$config['csrf_cookie_name'] = 'fanet_cookie';
