...
conf.reject_unauthorised_certificates = true;
...
conf.quit_message = "FurryAvalon Webchat client at https://chat.furryavalon.net";


// Default settings for the client. These may be changed in the browser
conf.client = {
    server: 'irc.furryavalon.net',
    port:    8000,
    ssl:     true,
    channel: '#FurryAvalon',
    channel_key: '',
    ...
    settings: {
        ...
        use_24_hour_timestamps: false,
        mute_sounds: false,
        show_emoticons: true,
        count_all_activity: true
    },
    window_title: 'FurryAvalon Webchat'
};
...
conf.restrict_server = "irc.furryavalon.net";
conf.restrict_server_port = 8000;
